...
Schema.voices.AddClass("Combine", function(client)
	local check1 = (client:IsCombine() && (not client:IsCombineSpecial()) && (not client:IsDispatch()) && (not client:Team() == FACTION_MPF))
	local check2 = client:IsFemaleDesc()
	return ((check1) && (not check2))
end)
